...
// [[Rcpp::export(rng = false)]]
int ac_ag_get_group_values( const AcAntigen ag ){ return ag.get_group_values(); }
// [[Rcpp::export(rng = false)]]
...
// [[Rcpp::export(rng = false)]]
AcAntigen ac_ag_set_group_values( AcAntigen ag, int value ){ ag.set_group_values(value); return ag; }
// [[Rcpp::export(rng = false)]]
