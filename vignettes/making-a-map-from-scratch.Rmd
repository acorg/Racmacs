---
title: "Making an antigenic map from scratch"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Making an antigenic map from scratch}
...
In this case we're going to try and find the best 2-dimensional solution for the map data, using 10 optimization runs, just for the sake of speed.
