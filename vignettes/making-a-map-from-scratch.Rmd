...
You can customise the colour, outline width and colour, and size of antigens using `agFill()`, `agOutlineWidth()`, `agOutline()`, and `agSize()` functions. Sera can be changed analogously using `srFill()`, `srOutlineWidth()`, `srOutline()`, and `srSize()`.
